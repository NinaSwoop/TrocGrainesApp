    ...
    public function addConfiguration(NodeDefinition $node): void
    {
        ...
        $builder
            ...
            ->arrayNode('signature_properties')
                ...
                ->info('An array of properties on your SymfonyUser that are used to sign the remember-me cookie. If any of these change, all existing cookies will become invalid.')
