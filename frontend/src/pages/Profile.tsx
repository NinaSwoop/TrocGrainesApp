    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row lg:justify-around bg-gray-100 pt-[5rem] lg:pt-[5rem]">
            <div className="flex flex-col bg-gray-100 pt-[5rem] lg:p-10">
                <div className="">
                <h1 className="text-3xl font-bold text-green-dark text-center">Mon profil</h1>
                </div>
            ...
            <div className="flex flex-col items-center justify-center p-10">
                <h1 className="text-3xl font-bold mb-10 text-green-dark text-center">Mes annonces</h1>
                {loading ? (
