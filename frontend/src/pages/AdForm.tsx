...
export default function AdForm() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        "Erreur lors de l'ajout de l'annonce. Réponse inattendue du serveur.",
      );
    }
  };
        ...
        <div className="bg-beige p-10 rounded-lg shadow-md">
          ...
          >
            <div className="grid grid-cols-1 gap-4 text-sm lg:text-base">
              ...
              />
              {errors.category && (
                <Error title="Erreur" text={errors.category} />
              )}
              <TextArea
                label="Description"
              ...
              />
              {errors.description && (
                <Error title="Erreur" text={errors.description} />
              )}
              ...
              />
              {errors.location && (
                <Error title="Erreur" text={errors.location} />
              )}
            </div>
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <p className="text-sm text-gray-500">
                    Êtes-vous sûr de vouloir annuler la saisie ?
                  </p>
                </div>
              </div>
            </div>
