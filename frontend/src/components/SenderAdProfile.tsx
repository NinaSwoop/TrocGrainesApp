    ...
    return (
        <>
            <div className="bg-beige p-10 rounded-lg shadow-md mb-10 lg:grid">
                ...
                <div>
                <p className="mt-4 text-sm lg:text-xl text-green-dark">Publiée il y a : {timeAgo}</p>
                </div>
                {adCard.adStatus === "reserved" && (
                    <div className="">
                        Vous avez réservé cette annonce
                    </div>
                )}
                            ...
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 className="text-base font-semibold text-gray-900">Supprimer l'annonce</h3>
                                        <p className="text-sm text-gray-500">Êtes-vous sûr de vouloir supprimer l'annonce ?</p>
                                        <span className="text-sm text-gray-500">Cette action est irréversible.</span>
                                    </div>
                                </div>
                            </div>
                            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button onClick={() => { handleCancel(); handleDelete(); }}
