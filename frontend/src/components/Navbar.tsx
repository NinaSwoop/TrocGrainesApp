        ...
        <div className="flex items-center">
          <div className="flex items-center">
            <div className="flex items-center">
              {user ? (
                <button
                  ...
                  className="flex items-center green-darker"
                >
                  <p className="md:text-sm lg:text-base mr-2">
                    {user.username}
                  </p>
                  <img
                    src={placeholder}
                    alt="avatar of plant"
                    className="h-10 w-10 cursor-pointer rounded-full mr-8"
                  />
                </button>
              ) : (
                ""
            ...
            <div className="">
              {user ? (
                <button
                  onClick={() => (window.location.href = "/help_points")}
                  className="flex items-center green-darker"
                >
                  <p className="md:text-sm lg:text-base mr-2">
                    {user.point_balance}
                  ...
                  <img
                    src={leaveLogo}
                    alt="leave icon"
                    className="h-7 mr-8 cursor-pointer"
                  />
                </button>
              ) : (
                ""
          ...
          <div className="">
            <button
              ...
              className="flex items-center green-darker cursor-pointer"
            >
              <img
                src={helpdeskLogo}
                alt="helpdesk icon"
